import random #To generate random pipes
import sys  #To call sys.exit command to close game
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption('Flappy Bird Game by Umang')
    ...
    GAME_SPRITES['base'] = pygame.image.load(GROUND).convert_alpha()
